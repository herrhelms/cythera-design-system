...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Gap element — tracks the real sidebar width for layout push */}
      <div
        className={cn(
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "cursor-w-resize group-data-[side=right]:cursor-e-resize",
  ...
  return (
    <input
      ...
      className={cn(
        ...
        "rounded-md border border-sidebar-border px-2 text-sm text-sidebar-foreground",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear outline-none",
    ...
    >
      {showIcon && (
        <div
          ...
          className="size-4 shrink-0 rounded-md bg-sidebar-accent"
        />
      )}
      <div
