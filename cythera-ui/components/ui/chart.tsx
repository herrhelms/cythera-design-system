...
// Cythera signature colors mapped to chart slots
// chart-1: cyan (primary accent)
// chart-2: lime (secondary accent)
// chart-3: orange (warning/highlight)
// chart-4: purple (alternate accent)
// chart-5: muted foreground (neutral)
